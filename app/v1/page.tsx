 ...
 *
 * Identisch zur aktuellen Beta-Landing in app/page.tsx, mit zwei
 * Änderungen:
 *   - Hero-CTA + Sprache auf Vollpreis-Public-Launch umgestellt (statt
 ...
 *     zwei Plan-Cards (Monthly €24.99, Yearly €199 mit Best-Value-Badge).
 *     Plan-Click → /checkout?plan=...
 *   - Nav: "Sign in"-Link für existierende User + "Get Callday"-CTA.
 *
 * Zweck: Preview der Public-Launch-Variante während die aktuelle
 * /page.tsx (Beta-Application-Form) live bleibt für Founder-List-
 * Aufbau. Bei Public Launch wird /v1 → / promoted (entweder durch
 * Content-Swap oder Redirect).
 *
 * Robots: noindex,nofollow solange Preview — vermeidet dass Google
 * beide Versionen indexiert.
 */
    ...
    <>
      ...
      <nav className="site-nav" data-scrolled="true">
        <div className="container nav-inner">
          <Link href="/v1" className="logo" style={{ textDecoration: "none" }}>
            <CalldayLogo size={32} />
            Callday
          </Link>
        ...
        <div className="container hero-inner">
          ...
          <div className="hero-cta-wrap reveal delay-3">
            ...
            <p className="hero-cta-meta">
              From €24.99/month. Cancel or pause anytime.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="pricing-section" id="pricing">
        <div className="container">
          ...
          <p className="section-sub">
            One plan, two payment cycles. Cancel or pause anytime.
          </p>
